    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="" method="post" id="order_edit">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="date" value="{{ $order->date }}" readonly name="date"
                                               class="form-control">
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" value="{{ $old_out_standing }}" name="old_out_standing"
                                               id="old_out_standing" disabled class="form-control">
                                    </div>
                                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        @foreach ($order_details as $key => $item)
                                            ...
                                            <div class="old-products row" id="old_item_row_{{ $key }}">
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="form-group">
                                                        <button class="old-product-delete-btn {{ $order->approval == 1 ? 'd-none' : '' }}"
                                                                onclick="oldItemDelete({{ $item->id }}, {{ $key }})"
                                                                type="button">X
                                                        </button>
                                                ...
                                                <div class="col-sm-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="stock_{{ $key }}"
                                                               value="{{ $item->stock }}"
                                                               class="form-control custom_disabled">
                                                    </div>
                                                </div>
                                ...
                                <div class="form-group col-md-3 {{ $order->approval == 1 ? 'd-none' : '' }}" style="margin-top: 35px">
                                    <a class="btn btn-sm btn-primary" onclick="addNewItem()"><i class="fa fa-plus"></i></a>
                                    <a class="btn btn-sm btn-danger" onclick="removeItem(this)"><i
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $order->bill_without_discount }}" name="amount"
                                                   id="amount"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <select onchange="commissionCalculat()" name="commission_type"
                                                    id="commission_type" class="form-control">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input onchange="commissionCalculat()" type="text"
                                                   value="{{ $order->commission_value }}"
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input data-old-bill="{{ $order->bill }}" type="text"
                                                   value="{{ $order->bill }}" name="bill" id="bill"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $old_out_standing == 0 ? $order->bill : $order->bill+$old_out_standing }}"
                                ...
                                <div class="col-sm-4">
                                    <label for="approval">
                                        <input type="radio" required name="status" id="approval"
                                               value="approval" {{ $order->approval == 1 ? 'checked' : '' }} >
                                        Do you want to approve order
                                    </label>

                                    @if($order->approval != 1)
                                        <label for="cancel">
                                            <input type="radio" required name="status" id="cancel"
                                                   value="cancel" {{ $order->cancel == 1 ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    <a href="{{ route('order.approve.list') }}" class="btn btn-warning">Back</a>
                    @if($order->approval != 1)
...
@push('js')
    ...
    <script>
        @if($order->approval == 1)
            $("input, select").addClass('custom_disabled')
        @endif
                    ...
                    success: function (data) {
                        if (data.message) {
                            ...
                            if ($("#approval").is(":checked")) {
                                var page_name = 'approve';
                            } else {
                                var page_name = 'cancel';
                            }
                            setTimeout(function () {
                                window.location = "/order/" + page_name + "/list"
                            }, 2000);
                        }
                        $("form").trigger("reset");
