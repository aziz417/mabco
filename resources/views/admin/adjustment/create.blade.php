    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="" id="adjustment" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-10">
...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#adjustment").on("submit", function (e) {
                e.preventDefault();

                if ($(".valids").length > 0) {
                    alert('Adjustment will be less or equal to the old out standing')
                    return;
                }

                var formData = new FormData($("#adjustment").get(0));
