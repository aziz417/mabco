                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="order_quantity[]" value="{{ $product->order_quantity }}" id="order_quantity_{{ $key }}" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            ...
                                            <select name="product_return_reason_id[]" class="form-control " id="return_reason_{{ $key }}">
                                                ...
                                                @forelse($return_reasons as $return_reason)
                                                    <option value="{{ $return_reason->id }}" {{ $product->product_return_reason_id == $return_reason->id ? 'selected' : '' }} >{{ $return_reason->title }}</option>
                                                @empty
                                                    <h2>No data</h2>
                                                @endforelse
                                            </select>
                                    ...
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            ...
                                            <input onchange="calculation(this, {{ $key }})" required type="number" min="0" max="{{ $product->order_quantity }}" value="{{ $product->return_quantity }}" name="return_quantity[]" id="return_quantity_{{ $key }}"
                                    ...
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="total_price_{{ $key }}" data-old-sub-total="{{ $product->return_quantity * $product->product_price }}" value="{{ $product->return_quantity * $product->product_price }}" name="sub_total_price[]" required
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <select name="commission_type" onchange="commissionCalculat()" id="commission_type"
                                                ...
                                                <option value="percentage" {{ $return->commission_type == 'percentage' ? 'selected' : '' }}>Percentage (%)</option>
                                                <option value="taka" {{ $return->commission_type == 'taka' ? 'selected' : '' }}>Taka</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" onchange="commissionCalculat()" name="commission_value"
                                                   id="commission_value" value="{{ $return->commission_value }}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $return->discount }}" name="discount" id="total_discount"
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" data-old-bill="{{ $return->return_amount }}" name="return_amount" id="bill" value="{{ $return->return_amount }}" class="form-control custom_disabled">
                                        </div>
                                    </div>
...
@push('js')
    <script>
        ...
        function calculation(e, rowId) {
            ...
            if (newSubTotal > oldSubTotal){
                subTotal = parseFloat(newSubTotal) - parseFloat(oldSubTotal);
            }else{
                subTotal = parseFloat(oldSubTotal) - parseFloat(newSubTotal);
            }

            $("#total_price_" + rowId).val(newSubTotal)
        ...
        function totalAmountCalculation() {
            ...
            in_total_out_standing = old_out_standing - in_total_bill;
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#product_return_edit").on("submit", function (e) {
                e.preventDefault();
                ...
                var formData = new FormData($("#product_return_edit").get(0));
                var id = $("#return_id").val();

                $.ajax({
                    url : "{{ route('return.update','') }}/"+id,
                    type: "post",
                    data: formData,
                    dataType: "json",
                    contentType: false,
