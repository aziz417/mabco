...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="" method="post" id="brand_edit">
                    @method('PUT')
                    @csrf

                    <input type="hidden" name="" id="brand_id" value="{{ $brand->id }}">
                    ...
                    <div class="form-group">
                        <a href="{{ route('brand') }}" class="btn btn-warning">Back</a>
...
<script>
    $(document).ready(function () {
        ...
        $("#brand_edit").on("submit",function (e) {
            ...
            var formData = new FormData( $("#brand_edit").get(0));
